...
if (isset($_POST['add_pelanggan'])) {
    ...
    // Query Add Data
    $query = "INSERT INTO pelanggan (ID, nama_depan , nama_belakang , no_telp) VALUES ('$id_pelanggan','$nama_depan','$nama_belakang','$no_telp')";
...
if (isset($_POST['update_pelanggan'])) {
    ...
    // Query Update data
    $query =  "UPDATE pelanggan SET ID='$id_pelanggan', nama_depan='$nama_depan', nama_belakang='$nama_belakang', no_telp='$no_telp' 
