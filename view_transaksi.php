            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    if (res.status_pembayaran == 200) {
                        ...
                        $('#st').val(res.data.status_pembayaran);
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    if (res.status_pembayaran == 200) {
                        ...
                        $('#tabel_data').load(location.href + " #tabel_data");
                    } else if (res.status_pembayaran == 422) {
                        alert(res.message);
                    }
                }
            });
